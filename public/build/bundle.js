...
var app = (function () {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 275, 2, 9777);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file, 128, 9, 3518);
    			...
    			add_location(path1, file, 132, 10, 3735);
    			attr_dev(path2, "fill", "none");
    			attr_dev(path2, "d", "M0 0h36v36H0z");
    			attr_dev(path2, "class", "svelte-6su8dw");
    			add_location(path2, file, 136, 10, 3932);
    			...
    			add_location(svg0, file, 118, 6, 3212);
    			attr_dev(div0, "id", "home");
    			attr_dev(div0, "class", "svelte-6su8dw");
    			add_location(div0, file, 112, 4, 3069);
    			...
    			add_location(path3, file, 185, 11, 5801);
    			...
    			add_location(path4, file, 223, 11, 7298);
    			...
    			add_location(svg2, file, 213, 8, 6975);
    			...
    			add_location(path5, file, 239, 11, 8223);
    			...
    			add_location(svg3, file, 229, 8, 7900);
    			attr_dev(div3, "id", "details");
    			attr_dev(div3, "class", "svelte-6su8dw");
    			add_location(div3, file, 212, 6, 6948);
    			...
    			add_location(path6, file, 258, 11, 8907);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 102, 2, 2797);
    			button.disabled = /*disabled*/ ctx[6];
    			attr_dev(button, "class", "svelte-6su8dw");
    			add_location(button, file, 109, 2, 2963);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file, 164, 11, 4801);
    			attr_dev(path1, "fill", "currentColor");
    			...
    			add_location(path1, file, 168, 12, 5024);
    			...
    			add_location(svg, file, 154, 8, 4490);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img_1, file, 141, 8, 4072);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(141:6) {#if recipe.imageUrls[0]}",
    		ctx
    	});
    ...
    // (194:8) {#each recipe.ingredients as ingredient}
    function create_each_block_1(ctx) {
    	let li;
    	let t0_value = /*ingredient*/ ctx[18].name + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file, 194, 10, 6433);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipe*/ 32 && t0_value !== (t0_value = /*ingredient*/ ctx[18].name + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(194:8) {#each recipe.ingredients as ingredient}",
    		ctx
    	});
    ...
    // (267:8) {#each recipe.instructions as step}
    function create_each_block(ctx) {
    	let li;
    	let t0_value = /*step*/ ctx[15].text + "";
    	let t0;
    	let t1;
    	let li_class_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(li, "class", li_class_value = "" + (null_to_empty(/*step*/ ctx[15].isOptional ? "optional" : "") + " svelte-6su8dw"));
    			add_location(li, file, 267, 10, 9610);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*recipe*/ 32 && t0_value !== (t0_value = /*step*/ ctx[15].text + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*recipe*/ 32 && li_class_value !== (li_class_value = "" + (null_to_empty(/*step*/ ctx[15].isOptional ? "optional" : "") + " svelte-6su8dw"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(267:8) {#each recipe.instructions as step}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		window.onbeforeprint = async () => {
    			...
    			if (!shortUrl.startsWith("http")) {
    				updateHistory();
    				return $$invalidate(3, shortUrl = null);
    			}
    	...
    	const click_handler = () => ($$invalidate(1, page = "home"), $$invalidate(3, shortUrl = null), $$invalidate(5, recipe = {}), $$invalidate(6, disabled = true));
    	...
    	? $$invalidate(5, recipe.imageUrls = [], recipe)
    	: $$invalidate(4, img.src = `https://cors.explosionscratc.repl.co/${img.src.split("//")[1]}`, img);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('printing' in $$props) printing = $$props.printing;
